...
| <a name="input_node_groups_default_security_groups_id"></a> [node\_groups\_default\_security\_groups\_id](#input\_node\_groups\_default\_security\_groups\_id) | A list of default IDs for node groups. Will be used if node\_groups[<group>].security\_group\_ids is empty | `list(string)` | `[]` | no |
